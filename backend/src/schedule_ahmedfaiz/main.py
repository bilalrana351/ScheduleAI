from src.validators.inputs import get_schedule_inputs
from src.validators.validator import validate_inputs
...
def main():
    ...
    scheduled_tasks = backtracking_slot_placement(wake_up, sleep, obligations, regular_tasks)
