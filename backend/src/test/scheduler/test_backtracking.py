...
from src.schedulers.backtracking import backtracking_slot_placement, generate_domains, filter_domain_by_preference
...
class TestBacktrackingScheduler:
    ...
    def test_basic_scheduling(self, basic_schedule_params):
        ...
        result = backtracking_slot_placement(**basic_schedule_params)
    ...
    def test_tight_schedule(self):
        ...
        result = backtracking_slot_placement(**params)
        assert result is not None
        assert len(result["tasks"]) == 2
